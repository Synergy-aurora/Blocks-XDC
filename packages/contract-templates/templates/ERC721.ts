...
export const TEMPLATE: Template = {
  templateId: '2',
  name: 'XRC721 NFT Contract',
  description:
    'XRC721 is an open standard for creating non-fungible tokens (NFTs) on the blockchain, allowing for the ownership and transfer of unique assets.',
  tags: ['NFT', 'XRC721'],
  code: CODE.trim(),
  inputs: [
    {
